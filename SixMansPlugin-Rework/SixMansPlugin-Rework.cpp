...
void SixMansPlugin::onLoad()
{
	...
	//cvar2.addOnValueChanged(std::bind(&SixMansPlugin-Rework::YourPluginMethod, this, _1, _2));
	...
	//gameWrapper->HookEventWithCallerPost<ActorWrapper>("FUNCTIONNAME", std::bind(&SixMansPlugin-Rework::FUNCTION, this, _1, _2, _3));
